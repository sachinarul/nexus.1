    ...
    return (
        <div className="h-full overflow-y-auto pr-2 custom-scrollbar">
            <div className="flex items-center justify-between mb-6 sticky top-0 bg-navy/95 backdrop-blur-md z-10 py-2 border-b border-white/5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-xs">Education Website</p>
                    </div>
                </div>
                <button className="text-xs text-[#1877F2] bg-white hover:bg-gray-100 font-bold px-3 py-1.5 rounded transition-colors flex items-center gap-1">
            ...
            <div className="space-y-4">
                {facebookPosts.map((post) => (
                    <div key={post.id} className="bg-white/5 rounded-xl border border-white/5 p-4 hover:border-white/10 transition-colors">
                        ...
                        {post.image && (
                            <img src={post.image} alt="FB Post" className="w-full rounded-lg mb-3 border border-white/5" />
                        )}
            ...
            <div className="mt-4 text-center">
                <a href="https://www.facebook.com/share/1QyeyH9suF/" target="_blank" className="text-xs text-gray-500 hover:text-white transition-colors">Go to Facebook Page →</a>
            </div>
        </div>
    );
};
