        ...
        <section className="min-h-screen bg-[#F8FAFC] flex pt-28 pb-12 lg:pt-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 flex flex-1">
                ...
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-3xl font-bold font-display text-[#111111] mb-2">Welcome Back</h2>
                    <p className="text-[#555555] font-medium text-sm">Sign in to your Nexus Dashboard</p>
                </div>
                ...
                <div className="relative flex items-center justify-center mb-6">
                    ...
                    <span className="px-4 text-xs text-[#555555] font-bold uppercase tracking-wider">Or login with email</span>
                    <div className="flex-grow border-t border-gray-200"></div>
                </div>

                <form onSubmit={handleLogin} className="space-y-6">
                    <div>
                        <label className="block text-[#555555] text-xs font-bold uppercase tracking-wider mb-2">Email Address</label>
                        <input
                            type="email"
                            className="w-full bg-[#FFFFFF] border border-gray-200 rounded-lg px-4 py-3 text-[#111111] focus:border-[#0F766E] focus:ring-1 focus:ring-[#0F766E] outline-none transition-colors shadow-sm placeholder:text-gray-400"
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            <label className="block text-[#555555] text-xs font-bold uppercase tracking-wider">Password</label>
                            <button type="button" onClick={handleResetPassword} className="text-xs text-[#0F766E] hover:text-[#2563EB] transition-colors font-bold">Forgot Password?</button>
                        </div>
                        <div className="relative">
                            <input
                                type={showPassword ? "text" : "password"}
                                className="w-full bg-[#FFFFFF] border border-gray-200 rounded-lg px-4 py-3 pr-12 text-[#111111] focus:border-[#0F766E] focus:ring-1 focus:ring-[#0F766E] outline-none transition-colors shadow-sm placeholder:text-gray-400"
                                placeholder="••••••••"
                                value={password}
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#0F766E] hover:bg-teal-700 text-white font-bold py-3.5 rounded-lg shadow-md transition-all transform active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center gap-2"
                    >
