        ...
        <section className="min-h-screen bg-navy flex items-center justify-center relative overflow-hidden">
            ...
            >
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full bg-white text-gray-900 font-bold py-3.5 rounded-lg shadow-lg hover:bg-gray-100 transition-all transform active:scale-95 flex items-center justify-center gap-3 mb-6 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            type="password"
                            className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-3 text-white focus:border-purple focus:ring-1 focus:ring-purple outline-none transition-colors"
                            placeholder="••••••••"
                            value={password}
