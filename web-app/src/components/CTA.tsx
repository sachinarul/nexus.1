            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <div className="max-w-4xl mx-auto backdrop-blur-3xl bg-white/5 border border-white/10 rounded-3xl p-12 md:p-20 shadow-2xl relative group hover:border-teal/30 transition-all duration-500">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <button className="px-10 py-4 bg-white text-navy font-bold rounded-lg hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-all hover:scale-105">
                            Start Your Free Trial
                        </button>
                        <button className="px-10 py-4 border border-white/20 hover:bg-white/10 text-white font-bold rounded-lg transition-all backdrop-blur-sm">
